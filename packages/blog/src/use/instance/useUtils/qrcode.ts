...
class QRCodeModel {
    ...
    public static createData(typeNumber, errorCorrectLevel, dataList) {
        let rsBlocks: any[] = QRRSBlock.getRSBlocks(typeNumber, errorCorrectLevel)
...
class QRCode {
    ...
    public init(opt?: Partial<QRCodeOptions>) {
        Object.assign(this.opt, opt)
        return this
    }

    public create(text: string, options?: Partial<QRCodeOptions>) {
